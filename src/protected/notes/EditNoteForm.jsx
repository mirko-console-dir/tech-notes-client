...
import updateNoteMutation from "../../api/notes/mutations/updateNote";
import deleteNoteMutation from "../../api/notes/mutations/deleteNote";
...
const EditNoteForm = ({ note, users }) => {
  ...
  const canSave =
    ([title, text, userId].every(Boolean) && !isUpdateLoading) ||
    !isDeleteLoading;
